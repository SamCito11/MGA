...
export const GenericList = ({
  ...
  userRole, // Nuevo prop para controlar el rol del usuario
}) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Botón de crear (solo visible para admin) */}
                ...
                {(onEdit || onDelete || onCancel || onView) && (
                  ...
                  >
                    <Box sx={{ display: "flex", justifyContent: "center", gap: 1 }}>
                      ...
                      {onDelete && (userRole === "admin" || userRole === "profesor") && (
                        <IconButton
